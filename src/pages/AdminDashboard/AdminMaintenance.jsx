...
const Maintenance = () => {
  ...
  const handleNavigation = useCallback((item) => {
    ...
    if (item.text === 'Carpentry') navigate('/adminCarpentry');
    if (item.text === 'Electrical') navigate('/adminElectrical');
    if (item.text === 'Air-Conditioning') navigate('/adminAirconditioning');
  }, [navigate]);
